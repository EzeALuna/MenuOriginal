const menuItems = [
    { id: 1, name: "Hamburguesa Clásica", price: 5.99, image: "/placeholder.svg?height=100&width=100&text=Clásica", extras: [
        { name: "queso", price: 0.50 },
        { name: "bacon", price: 1.00 },
        { name: "huevo", price: 0.75 }
    ]},
    { id: 2, name: "Hamburguesa Doble", price: 7.99, image: "/placeholder.svg?height=100&width=100&text=Doble", extras: [
        { name: "queso", price: 0.50 },
        { name: "bacon", price: 1.00 },
        { name: "huevo", price: 0.75 }
    ]},
    { id: 3, name: "Papas Fritas", price: 2.99, image: "/placeholder.svg?height=100&width=100&text=Papas", extras: [
        { name: "queso", price: 0.50 },
        { name: "bacon", price: 1.00 }
    ]},
    { id: 4, name: "Refresco", price: 1.99, image: "/placeholder.svg?height=100&width=100&text=Refresco", extras: [] }
];
